...
- השתמש בנקודות ייחוס: גובה מעקה ≈ 1.0–1.1 מ׳, דלת ≈ 2.0 מ׳
- אם אין רמזי גודל ברורים — הטה לצד הקטן

הנחיות לצבעים:
- זהה את צבעי הדומיננטיים של הרצפה, הקירות, המעקה
- תאר בשמות צבע פשוטים (חום, אפור, לבן, בז', שחור, עץ טבעי)
- זה ישמש להחלטה על צבע האדניות
    ...
    async start(ctrl) {
      ...
      try {
        ...
        let analysis: Record<string, string | number> = {
          ...
          sun_exposure: "חצי צל", style: "מודרני", railing: "זכוכית",
