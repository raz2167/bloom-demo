"use client";
// app/page.tsx
// ממשק הדמו הראשי — מובייל ראשון, עברית RTL
...
function LoadingScreen({ step }: { step: number }) {
  return (
    ...
    >
      ...
      <h2
        style={{ color: "#2d5a27", fontSize: "20px", marginBottom: "40px", fontWeight: "700" }}
      >
        bloom עובד בשבילך...
      </h2>
      {STEPS.map((s, i) => (
    ...
    >
      ...
      <div style={{ padding: "16px" }}>
        ...
        >
          ...
          <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
            {[
              ...
              SIZE_LABEL[result.analysis.balcony_size],
        ...
        >
          ...
          >
            <div>
              <div style={{ fontWeight: "700", color: "#2d5a27", fontSize: "15px" }}>
                סה״כ ערכה
              </div>
        ...
        {!ordered ? (
          ...
          >
            ...
            <div
              style={{ color: "#2d5a27", fontWeight: "700", fontSize: "16px" }}
            >
              ההזמנה התקבלה!
            </div>
